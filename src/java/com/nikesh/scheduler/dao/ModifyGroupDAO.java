...
public class ModifyGroupDAO {
    ...
    public ModifyGroupDAO() throws SQLException, ClassNotFoundException{
        connection = DatabaseTool.getConnection();
    }
    
    public int deleteGroup(String groupId) throws SQLException, ClassNotFoundException{
        connection = DatabaseTool.getConnection();
    ...
    public int addModifiedGroup(Group group) throws SQLException, ClassNotFoundException{
        connection = DatabaseTool.getConnection();
